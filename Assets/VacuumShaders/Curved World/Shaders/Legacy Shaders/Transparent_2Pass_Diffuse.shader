...
Shader "Hidden/VacuumShaders/Curved World/Legacy Shader/Transparent (2 Pass)/Diffuse" 
{
	Properties 
	{
	...
	SubShader 
	{
		Tags { "Queue"="Transparent" 
			   ...
			   "CurvedWorldTag"="Legacy Shader/Transparent (2 Pass)/Diffuse" 
		...
		CGPROGRAM
		#pragma surface surf BlinnPhong alpha:blend noshadow vertex:vert nodirlightmap nodynlightmap
		#pragma target 3.0
