...
Shader "Hidden/VacuumShaders/Curved World/Legacy Shader/Additive (2 Pass)/Vertex Alpha" 
{
	Properties 
	{
	...
	{     
		Tags { "Queue"="Transparent" 
			   ...
			   "CurvedWorldTag"="Legacy Shader/Additive (2 Pass)/Vertex Alpha" 
		...
		CGPROGRAM 
		#pragma surface surf BlinnPhong vertex:vert noshadow nodirlightmap nodynlightmap
		#pragma target 3.0 
