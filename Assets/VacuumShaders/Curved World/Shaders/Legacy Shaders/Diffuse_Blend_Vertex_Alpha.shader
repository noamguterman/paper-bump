...
Shader "Hidden/VacuumShaders/Curved World/Legacy Shader/Opaque/Vertex Alpha" 
{
	Properties 
	{
	...
	{     
		Tags { "RenderType"="CurvedWorld_Opaque"  
			   "CurvedWorldTag"="Legacy Shader/Opaque/Vertex Alpha" 
			   "CurvedWorldNoneRemoveableKeywords"=""  
			   "CurvedWorldAvailableOptions"="V_CW_REFLECTIVE;_EMISSION;V_CW_RIM;_NORMALMAP;V_CW_SPECULAR_HD;VERTEX_COLOR;" 
			 } 
		LOD 200
