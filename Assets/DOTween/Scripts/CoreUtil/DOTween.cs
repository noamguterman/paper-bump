...
namespace DG.Tweening
{
    ...
    public class DOTween
    {
        ...
        // public ► Can only be set via DOTween's Utility Panel
        ...
        /// <summary>Used publicly. Assigned/removed by DOTweenComponent.Create/DestroyInstance</summary>
