...
namespace DG.Tweening
{
    ...
    public static class DOVirtual
    {
        ...
        {
            return from + (to - from) * EaseManager.Evaluate(Ease.public_Custom, new EaseCurve(easeCurve).Evaluate, lifetimePercentage, 1, DOTween.defaultEaseOvershootOrAmplitude, DOTween.defaultEasePeriod);
        }
