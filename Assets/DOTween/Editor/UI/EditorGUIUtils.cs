...
namespace DG.DOTweenEditor.UI
{
    public static class EditorGUIUtils
    {
        ...
        public static readonly string[] FilteredEaseTypes = new[] {
            ...
            "OutBounce",
            "InOutBounce",
            ":: AnimationCurve" // Must be set manually to public_Custom
        };
        ...
        {
            int stringEaseId = currEase == Ease.public_Custom
            ...
            return stringEaseId == FilteredEaseTypes.Length - 1 ? Ease.public_Custom : (Ease)Enum.Parse(typeof(Ease), FilteredEaseTypes[stringEaseId]);
        }
